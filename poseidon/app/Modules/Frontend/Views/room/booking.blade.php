        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <br>
                    <label class="det_type">Room:</label>
                    <label>{{$room->room_number}}</label>
                    <br>
                    <label class="det_type">Description</label>
                    <p>{{$room->description}}</p>
                    <label class="det_type">Adults Capacity:</label>
                    <label>{{$room->max_adults}}</label>
                    <label class="det_type">Children Capacity:</label>
                    <label>{{$room->max_adults}}</label>
                    <label class="det_type">No. Bathrooms:</label>
                    <label>{{$room->max_adults}}</label>
                    <br>
                    <label class="det_type">Smoking:</label>
                    <label>@if( $room->smoking == 1) Yes @else
                            No @endif</label>
                    <br>
                    <label class="det_type">Cost per night:</label>
                    <label>{{number_format((double)$room->room_cost)}}
                        CAD</label>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-md-6">
                    <label class="value">1</label> <label>room(s)
                        for</label><label
                                ...
                                <form role="form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username"
                                               placeholder="Jason Doe" required
                                               class="form-control">
                                    </div>
                                    <div class="form-group">
