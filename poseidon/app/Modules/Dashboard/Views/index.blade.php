    ...
    <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="/admin/booking" class="small-box-footer">More info
                        <i
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3>${{ $total_paid }}<sup
                                    style="font-size: 20px">CAD</sup></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    ...
                    <a href="/admin/customers" class="small-box-footer">More
                        info <i
                                class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Upcoming Bookings
                    <small>For 3 Months</small>
                </h3>
            </div>
            <div class="box-body">
                    ...
                    <table id="booking"
                        ...
                        @foreach($bookings as $booking)
                            <tr>
                                ...
                                <td>
                                    <a href="tel:{{ $booking->user->person->phone_number }}">{{ $booking->user->person->phone_number }}</a>
                                </td>
                                <td>{{ $booking->id }}</td>
